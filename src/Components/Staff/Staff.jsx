        ...
        <div className="staff pt-4">
            <div className="container staff-container">
                <div className="row d-flex ai-c jc-sb py-5">
                    ...
                    <div className="col-md-3 col-sm-12 col-xs-12 staff-card staff-card-1 px-0 mb-5">
                    ...
                    <div className="col-md-3 col-sm-12 col-xs-12 staff-card staff-card-2 px-0 mb-5">
                    ...
                    <div className="col-md-3 col-sm-12 col-xs-12 staff-card staff-card-3 px-0 mb-5">
